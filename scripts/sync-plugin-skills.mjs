...
// plugins/rankloupe/skills/* must be real files, not symlinks to .agents/skills/*.
...
const targetDir = join(repoRoot, "plugins/rankloupe/skills");
...
console.log(`Synced ${skills.length} skills into plugins/rankloupe/skills/`);
